...
CHANNEL_BUTTON_TEXT = "Number Chanel"     # প্রথম বাটনের লেখা
CHANNEL_USERNAME = "pakcyberteat"   # আপনার চ্যানেলের ইউজারনেম (শুধু ইউজারনেম, @ ছাড়া)

SUPPORT_BUTTON_TEXT = "support"         # দ্বিতীয় বাটনের লেখা
SUPPORT_USERNAME = "unknownboy8314" # আপনার সাপোর্টের ইউজারনেম (শুধু ইউজারনেম, @ ছাড়া)
# ===========================================
